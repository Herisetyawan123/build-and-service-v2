...
const teamData: CardTeamProps[] = [
  {
    ...
    description: "I'm a Fullstack Web Developer and Mobile Developer with Flutter",
    image: Perdana,
  ...
  {
    name: 'Heri Setyawan',
    description: "I'm a Fullstack Developer in website and mobile flutter developer.",
    image: Heri,
  ...
  },
  {
    ...
    description: "I'm a Fullstack Web Developer esspecially with laravel and mobile developer with Flutter",
    image: Rafi,
