    ...
    <div>
      <main className="h-screen w-full flex flex-col justify-center items-center bg-[#1A2238]">
        ...
        <button className="mt-5">
          <Link href="/" className='relative inline-block px-3 py-1 md:px-6 md:py-3 font-medium group my-6'>
          <span className='absolute inset-0 w-full h-full transition duration-200 ease-out transform translate-x-1 translate-y-1 bg-green-600 group-hover:-translate-x-0 group-hover:-translate-y-0'></span>
              ...
              <span className='relative text-green-600 text-sm md:text-lg group-hover:text-white'>Go Back Home</span>
          </Link>
        </button>
      </main>
    </div>
